...
if(TARGET_WATCH_EFM32GG_GCC_TOOLCHAIN_INCLUDED)
    return()
endif()
set(TARGET_WATCH_EFM32GG_GCC_TOOLCHAIN_INCLUDED 1)
...
#
add_definitions("-DWATCH -DEFM32GG995F1024 -DEFM32GG -DEFM32")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT    "${CMAKE_EXE_LINKER_FLAGS_INIT} -mcpu=cortex-m3 -mthumb -u _printf_float -T\"${CMAKE_CURRENT_LIST_DIR}/../ld/efm32gg.ld\"")
